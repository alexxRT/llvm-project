...
extern "C" LLVM_EXTERNAL_VISIBILITY void LLVMInitializeX52Target() {
  // Register the target.
  RegisterTargetMachine<X52TargetMachine> A(getTheX52Target());
}
...
X52TargetMachine::X52TargetMachine(const Target &T, const Triple &TT,
